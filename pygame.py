...
game_message = font.render('Press "r" to start',False,(111,196,169))
game_message_rect = game_message.get_rect(center = (400,340))

game_jump = font.render('Press space to jump',False,(111,196,169))
game_jump_rect = game_jump.get_rect(center = (400,375))
...
while True:
    ...
    #collision
        ...
        #game_active = collisions(player_rect,obstacle_rect_list)
         ...
         if score == 0 :screen.blit(game_message,game_message_rect)and screen.blit(game_jump,game_jump_rect)
